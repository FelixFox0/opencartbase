			...
			return this.each(function() {
				...
				$.getJSON("https://www.api.tweecool.com/?screenname=" + o.username + "&count=" + o.limit, function(data) {
					...
					$.each(data.tweets, function(i, field) {
						...
						wInner.append('' + pIMG + '<div class="tweetfeed-item-container tweetfeed-non-fixed tweetfeed-new-item"><span class="tweetfeed-twitter-icon"><i class="fa fa-twitter"></i></span><div class="tweetfeed-item-content">' + field.text.replace(urlpattern, '<a href="$1" target="_blank">$1</a>') + media + ' <span class="main_font" style="display:block;">' + timestamp + '</span></div></div>');
					});
