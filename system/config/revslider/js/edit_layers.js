...
var UniteLayersRev = new function() {
        ...
        t.setInitLayersJson = function(jsonLayers) {
        	if (typeof jsonLayers != "string" || !jsonLayers){
				initLayers = null;
        	}else{
        ...
        t.setInitLayerAnim = function(jsonLayersAnims) {
        	 if (typeof jsonLayersAnims != "string" || !jsonLayersAnims){
				initLayerAnims = null;
        	}else{
        ...
        t.setInitCaptionClasses = function(jsonClasses) {
        	if (typeof jsonClasses != "string" || !jsonClasses){
				initArrCaptionClasses = null;
        	}else{
        ...
        t.init = function(slideTime) {
            ...
            if (initLayers) {
                ...
                if (len) {
                    for (var i = 0; i < len; i++) addLayer(initLayers[i], true);
                } else {
                    for (key in initLayers) addLayer(initLayers[key], true);
                }
            }
            ...
            jQuery('.bgsrcchanger').each(function() {
                if (jQuery(this).is(':checked')) initSliderMainOptions(jQuery(this));
            });
            ...
            function initSliderMainOptions(jQueryObj) {
                ...
                jQuery('.bgsrcchanger-div').each(function() {
                    if (jQuery(this).attr('id') != "tp-bgimagesettings" || (jQuery(this).attr('id') == "tp-bgimagesettings" && t.data('imgsettings') != "on")) {
                        if (jQuery(this).attr('id') == "tp-bgimagesettings") jQuery(this).slideUp(200)
                        else jQuery(this).css({
                            display: "none"
                        });
                    }
                });
                jQuery('#' + t.data('callid')).css({
                    display: "block"
                });
                if (t.data('imgsettings') == "on") jQuery('#tp-bgimagesettings').slideDown(200);
            }
            /*! LAYER ANIMATION */
            /******************************
		-	ANIMATION CREATOR	-
	********************************/
            ...
            function animateCreatorIn() {
                ...
                if ($split == "chars" || $split == "words" || $split == "lines") {
                    ...
                    else nextcaption.data('mySplitText', new SplitText(nextcaption, {
                        type: "lines,words,chars"
                    }));
                }
                if ($split == "chars") {
                ...
                if (animobject != nextcaption) punchgs.TweenLite.set(nextcaption, {
                    opacity: 1,
                    scaleX: 1,
                    scaleY: 1,
                    rotationX: 0,
                ...
                setTimeout(function() {
                    if (cic.data('direction') == 0) animateCreatorIn();
                    else
                    if (cic.data('direction') == 1 || cic.data('direction') == 2) animateCreatorOut()
                }, (timedelay) + 500)
            }
            ...
            function animateCreatorOut() {
                ...
                if ($split == "chars") animobject = nextcaption.data('mySplitText').chars;
                if ($split == "words") animobject = nextcaption.data('mySplitText').words;
                if ($split == "lines") animobject = nextcaption.data('mySplitText').lines;
                var timedelay = ((animobject.length * mdelay) + speed) * 1000;
                punchgs.TweenLite.killTweensOf(animobject, false);
                if (animobject != nextcaption) punchgs.TweenLite.set(nextcaption, {
                    opacity: 1,
                ...
                setTimeout(function() {
                    ...
                    if (cic.data('direction') == 2) animateCreatorIn();
                    else
                    if (cic.data('direction') == 1) animateCreatorOut();
                }, (timedelay) + 500)
            }
            /*********************************
	...
	********************************/
            ...
            function setInAnimOfPreview() {
                ...
                punchgs.TweenLite.set(animobject, {
                    clearProps: "transform"
                });
                if (animobject != nextcaption) punchgs.TweenLite.set(nextcaption, {
                    opacity: 1,
	...
	********************************/
            function setOutAnimOfPreview() {
                ...
                if (anim == ('fadeout') || anim == ('ltr') || anim == ('ltl') || anim == ('str') || anim == ('stl') || anim == ('ltt') || anim == ('ltb') || anim == ('stt') || anim == ('stb') || anim == ('skewtoright') || anim == ('skewtorightshort') || anim == ('skewtoleft') || anim == ('skewtoleftshort')) {
                    if (anim == ('skewtoright') || anim == ('skewtorightshort')) skwX = 35
                    if (anim == ('skewtoleft') || anim == ('skewtoleftshort')) skwX = -35
                    if (anim == ('ltr') || anim == ('skewtoright')) xx = 560;
                    else if (anim == ('ltl') || anim == ('skewtoleft')) xx = -100;
                    else if (anim == ('ltt')) yy = -50;
                    else if (anim == ('ltb')) yy = 250;
                    ...
                    if (anim == ('skewtorightshort')) xx = 400;
                    if (anim == ('skewtoleftshort')) xx = 0
        ...
        var initAlignTable = function() {
            jQuery("#align_table a").click(function() {
                var obj = jQuery(this);
                if (jQuery("#align_table").hasClass("table_disabled")) return (false);
        ...
        var initHtmlFields = function() {
            ...
            jQuery("#layer_caption").autocomplete({
                ...
                var listItem = jQuery("<li></li>").data("item.autocomplete", item).append("<a>" + item.label + "</a>").appendTo(ul);
            ...
            jQuery("#layer_captions_down").click(function(event) {
                ...
                if (jQuery('#layer_caption').data("is_open") == true) jQuery("#layer_caption").autocomplete("close");
                else //else open autocomplete
                if (jQuery(this).hasClass("ui-state-active")) jQuery("#layer_caption").autocomplete("search", "").data("ui-autocomplete")._renderItem = function(ul, item) {
                    var listItem = jQuery("<li></li>").data("item.autocomplete", item).append("<a>" + item.label + "</a>").appendTo(ul);
                    listItem.attr('original-title', item.value);
                    return listItem;
                };
            ...
            jQuery("#font_family_down").click(function(event) {
                event.stopPropagation();
                //if opened - close autocomplete
                if (jQuery('#font_family').data("is_open") == true) jQuery("#font_family").autocomplete("close");
                else //else open autocomplete
                if (jQuery(this).hasClass("ui-state-active")) jQuery("#font_family").autocomplete("search", "").data("ui-autocomplete");
            });
            //handle autocomplete close
            ...
            jQuery(pressEnterFields).blur(function() {
                t.updateLayerFromFields();
            });
            ...
            jQuery("#layer_endtime").blur(validateCurrentLayerTimes).keypress(function(event) {
                if (event.keyCode == 13) validateCurrentLayerTimes();
            });
            //end speed update
        ...
        var initButtons = function() {
            ...
            jQuery("#button_delete_all").click(function() {
                if (confirm("Do you really want to delete all the layers?") == false) return (true);
                if (jQuery(this).hasClass("button-disabled")) return (false);
                deleteAllLayers();
            });
	...
	**************************************/
        ...
        var selectLayerAnim = function(handle) {
            ...
            animSelect.each(function() {
                if (jQuery(this).text() == handle) jQuery(this).prop('selected', true);
        ...
        var showHideOffsetRow = function() {
            ...
            if (value == "scroll_under") offsetRow.show();
            else offsetRow.hide();
        }
        /**
        ...
        var validateCurrentLayerTimes = function() {
            ...
            if (startTime >= endTime) markFieldError("#layer_endtime", "Must be greater then start time (" + startTime + ")");
            else unmarkFieldError("#layer_endtime");
        }
        /**
        ...
        var markFieldError = function(field_selector, errorTitle) {
            ...
            if (errorTitle) jQuery(field_selector).prop("title", errorTitle);
        }
        /**
        ...
        var getFirstStyle = function() {
            ...
            var firstStyle = "";
            if (arrClasses == null || arrClasses.length == 0) return ("");
        ...
        var getHtmlLayerFromSerial = function(serial, isDemo) {
            ...
            if (!isDemo) var htmlLayer = jQuery("#slide_layer_" + serial);
            else var htmlLayer = jQuery("#demo_layer_" + serial);
            if (htmlLayer.length == 0) UniteAdminRev.showErrorMessage("Html Layer with serial: " + serial + " not found!");
            return (htmlLayer);
        }
        /**
        ...
        var getLayer = function(serial) {
            var layer = arrLayers[serial];
            if (!layer) UniteAdminRev.showErrorMessage("getLayer error, Layer with serial:" + serial + "not found");
            //modify some data
        ...
        var makeLayerHtml = function(serial, objLayer, isDemo) {
            if (!isDemo) isDemo = false;
            var type = "text";
            if (objLayer.type) type = objLayer.type;
            ...
            if (objLayer.max_width !== 'auto') style += ' width: ' + objLayer.max_width + ';';
            if (objLayer.max_height !== 'auto') style += ' height: ' + objLayer.max_height + ';';
            ...
            if (!isDemo) var html = '<div id="slide_layer_' + serial + '" style="' + style + '" class="slide_layer"><div style="' + stylerot + '" class="innerslide_layer tp-caption ' + objLayer.style + static_class + '" >';
            else var html = '<div id="demo_layer_' + serial + '" style="' + style + ' display: none;" class="demo_layer demo_layer_' + curDemoSlideID + ' slide_layer tp-caption ' + objLayer.style + static_class + '" >';
                ...
                case "video":
                    ...
                    switch (objLayer.video_type) {
                        ...
                        case "vimeo":
                            ...
                            break;
                        case "html5":
                            if (useImage !== undefined && useImage != "") styleVideo += ";background-image:url(" + useImage + ");";
                            break;
                    }
        ...
        var addLayerImage = function(urlImage, special_type) {
            ...
            if (typeof special_type !== 'undefined') objLayer['special_type'] = special_type;
            addLayer(objLayer);
        }
        /**
        ...
        var getVideoObjLayer = function(videoData) {
            ...
            switch (objLayer.video_type) {
                ...
                case "html5":
                    ...
                    if (videoData.urlPoster != "") objLayer.video_image_url = videoData.urlPoster;
                    break;
            }
            return (objLayer);
        }
        ...
        var addLayer = function(objLayer, isInit, isDemo) {
            if (!isInit) var isInit = false;
            if (!isDemo) var isDemo = false;
            //set init fields (if not set):
            if (objLayer.order == undefined) objLayer.order = (id_counter);
            objLayer.order = Number(objLayer.order);
            //set init position
            if (objLayer.type == "video") {
                if (objLayer.left == undefined) objLayer.left = initLeftVideo;
                if (objLayer.top == undefined) objLayer.top = initTopVideo;
                objLayer = checkUpdateFullwidthVideo(objLayer);
            } else {
                if (objLayer.left == undefined) objLayer.left = initLeft;
                if (objLayer.top == undefined) objLayer.top = initTop;
            }
            //set Loop Animations
            if (objLayer.loop_animation == undefined) objLayer.loop_animation = jQuery("#layer_loop_animation option:selected").val();
            if (objLayer.loop_easing == undefined) objLayer.loop_easing = jQuery("#layer_loop_easing").val();
            if (objLayer.loop_speed == undefined) objLayer.loop_speed = jQuery("#layer_loop_speed").val();
            if (objLayer.loop_startdeg == undefined) objLayer.loop_startdeg = jQuery("#layer_loop_startdeg").val();
            if (objLayer.loop_enddeg == undefined) objLayer.loop_enddeg = jQuery("#layer_loop_enddeg").val();
            if (objLayer.loop_xorigin == undefined) objLayer.loop_xorigin = jQuery("#layer_loop_xorigin").val();
            if (objLayer.loop_yorigin == undefined) objLayer.loop_yorigin = jQuery("#layer_loop_yorigin").val();
            if (objLayer.loop_xstart == undefined) objLayer.loop_xstart = jQuery("#layer_loop_xstart").val();
            if (objLayer.loop_xend == undefined) objLayer.loop_xend = jQuery("#layer_loop_xend").val();
            if (objLayer.loop_ystart == undefined) objLayer.loop_ystart = jQuery("#layer_loop_ystart").val();
            if (objLayer.loop_yend == undefined) objLayer.loop_yend = jQuery("#layer_loop_yend").val();
            if (objLayer.loop_zoomstart == undefined) objLayer.loop_zoomstart = jQuery("#layer_loop_zoomstart").val();
            if (objLayer.loop_zoomend == undefined) objLayer.loop_zoomend = jQuery("#layer_loop_zoomend").val();
            if (objLayer.loop_angle == undefined) objLayer.loop_angle = jQuery("#layer_loop_angle").val();
            if (objLayer.loop_radius == undefined) objLayer.loop_radius = jQuery("#layer_loop_radius").val();
            //set animation:
            if (objLayer.animation == undefined) objLayer.animation = jQuery("#layer_animation option:selected").val();
            //set easing:
            if (objLayer.easing == undefined) objLayer.easing = jQuery("#layer_easing").val();
            if (objLayer.split == undefined) objLayer.split = jQuery("#layer_split").val();
            if (objLayer.endsplit == undefined) objLayer.endsplit = jQuery("#layer_endsplit").val();
            if (objLayer.splitdelay == undefined) objLayer.splitdelay = jQuery("#layer_splitdelay").val();
            if (objLayer.endsplitdelay == undefined) objLayer.endsplitdelay = jQuery("#layer_endsplitdelay").val();
            if (objLayer.max_height == undefined) objLayer.max_height = jQuery("#layer_max_height").val();
            if (objLayer.max_width == undefined) objLayer.max_width = jQuery("#layer_max_width").val();
            if (objLayer['2d_rotation'] == undefined) objLayer['2d_rotation'] = jQuery("#layer_2d_rotation").val();
            if (objLayer['2d_origin_x'] == undefined) objLayer['2d_origin_x'] = jQuery("#layer_2d_origin_x").val();
            if (objLayer['2d_origin_y'] == undefined) objLayer['2d_origin_y'] = jQuery("#layer_2d_origin_x").val();
            if (objLayer.parallax_level == undefined) objLayer.parallax_level = jQuery("#parallax_level").val();
            if (objLayer.whitespace == undefined) objLayer.whitespace = jQuery("#layer_whitespace option:selected").val();
            if (objLayer.static_start == undefined) objLayer.static_start = jQuery("#layer_static_start option:selected").val();
            if (objLayer.static_end == undefined) objLayer.static_end = jQuery("#layer_static_end option:selected").val();
            //set speed:
            if (objLayer.speed == undefined) objLayer.speed = initSpeed;
            if (objLayer.align_hor == undefined) objLayer.align_hor = "left";
            if (objLayer.align_vert == undefined) objLayer.align_vert = "top";
            //set animation:
            if (objLayer.hiddenunder == undefined) objLayer.hiddenunder = "";
            if (objLayer.resizeme == undefined) objLayer.resizeme = "true";
            //set image link
            if (objLayer.link == undefined) objLayer.link = "";
            //set image link open in
            if (objLayer.link_open_in == undefined) objLayer.link_open_in = "same";
            //set slide link:
            if (objLayer.link_slide == undefined) objLayer.link_slide = "nothing";
            //set scroll under offset
            if (objLayer.scrollunder_offset == undefined) objLayer.scrollunder_offset = "";
            //set style, if empty, add first style from the list
            if (objLayer.style == undefined) objLayer.style = jQuery("#layer_caption").val();
            ...
            //add time
            if (objLayer.time == undefined) objLayer.time = getNextTime();
            objLayer.time = Number(objLayer.time); //casting
            //end time:
            if (objLayer.endtime == undefined) objLayer.endtime = "";
            if (objLayer.endspeed == undefined) objLayer.endspeed = initSpeed;
            //set end animation:
            if (objLayer.endanimation == undefined) objLayer.endanimation = jQuery("#layer_endanimation").val();
            //set end easing:
            if (objLayer.endeasing == undefined) objLayer.endeasing = jQuery("#layer_endeasing").val();
            //set corners
            if (objLayer.corner_left == undefined) objLayer.corner_left = "nothing";
            if (objLayer.corner_right == undefined) objLayer.corner_right = "nothing";
            if (objLayer.width == undefined) objLayer.width = -1;
            objLayer.width = Number(objLayer.width);
            if (objLayer.height == undefined) objLayer.height = -1;
            ...
            if (!isDemo) arrLayers[id_counter] = jQuery.extend({}, objLayer);
            //add html
            ...
            if (!isDemo) addToSortbox(id_counter, objLayer);
            //refresh draggables
            if (!isDemo) refreshEvents(id_counter);
            id_counter++;
        ...
        var deleteLayerFromObject = function(serial) {
            ...
            for (key in arrLayers) {
                if (key != serial) arrLayersNew[key] = arrLayers[key];
                else flagFound = true;
            }
            if (flagFound == false) UniteAdminRev.showErrorMessage("Can't delete layer, serial: " + serial + " not found");
        ...
        var updateHtmlLayerPosition = function(isInit, htmlLayer, objLayer, top, left, align_hor, align_vert) {
            ...
            if (isInit == true && objLayer.type == "image") {
                if (objLayer.width != -1) width = objLayer.width;
                if (objLayer.height != -1) height = objLayer.height;
            }
        ...
        var checkUpdateFullwidthVideo = function(objLayer) {
            if (objLayer.type != "video") return (objLayer);
            if (typeof(objLayer.video_data) !== "undefined") {
        ...
        var updateHtmlLayersFromObject = function(serial, posresets) {
            ...
            if (posresets) updateHtmlLayerPosition(false, htmlLayer, objLayer, objLayer.top, objLayer.left, objLayer.align_hor, objLayer.align_vert);
	...
	**/
        ...
        t.updateLayerFromFields = function() {
            ...
            switch (type) {
                case 'text':
                    ...
                    jQuery('#slide_layer_' + selectedLayerSerial + ' .innerslide_layer').css({
                        'maxWidth': objUpdate.max_width
                    });
                    jQuery('#slide_layer_' + selectedLayerSerial + ' .innerslide_layer').css({
                        'maxHeight': objUpdate.max_height
                    });
                    jQuery('#slide_layer_' + selectedLayerSerial + ' .innerslide_layer').css({
                        'whiteSpace': objUpdate.whitespace
                    });
                    jQuery('#slide_layer_' + selectedLayerSerial).css({
                        'width': "auto"
                    });
                    jQuery('#slide_layer_' + selectedLayerSerial).css({
                        'height': "auto"
            ...
            switch (type) {
                ...
                case 'image':
                    ...
                    punchgs.TweenLite.set(jQuery('#slide_layer_' + selectedLayerSerial + ' .innerslide_layer'), {
                        rotationZ: rotation,
                        transformOrigin: trorigin,
                        overwrite: "auto"
                    });
                    break;
            }
        ...
        var updateLayerFormFields = function(serial) {
            ...
            if (objLayer.scaleProportional == "true" || objLayer.scaleProportional == true) jQuery("#layer_proportional_scale").prop("checked", true);
            else jQuery("#layer_proportional_scale").prop("checked", false);
            ...
            if (objLayer.hiddenunder == "true" || objLayer.hiddenunder == true) jQuery("#layer_hidden").prop("checked", true);
            else jQuery("#layer_hidden").prop("checked", false);
            if (objLayer.resizeme == "true" || objLayer.resizeme == true) jQuery("#layer_resizeme").prop("checked", true);
            else jQuery("#layer_resizeme").prop("checked", false);
        ...
        var setLayerSelected = function(serial) {
            if (selectedLayerSerial == serial) return (false);
            ...
            switch (objLayer.type) {
                ...
                case "image":
                    ...
                    if (jQuery("#layer_proportional_scale").is(":checked")) var aspectratio = true;
                    else var aspectratio = false;
                    layer.resizable({
                        ...
                        start: function(event, ui) {
                            ...
                            ui.element.find('.innerslide_layer').css({
                                width: "100%",
                                height: "100%"
                            });
                        },
                ...
                default: //set layer text to default height
                    ...
                    layer.resizable({
                        ...
                        stop: function(event, ui) {
                            ...
                            setTimeout(function() {
                                il.css({
                                    "maxWidth": il.outerWidth(),
                                    "maxHeight": il.outerHeight()
                                });
        ...
        var hideLayer = function(serial, skipGlobalButton) {
            ...
            if (skipGlobalButton != true) {
                if (isAllLayersHidden()) jQuery("#button_sort_visibility").addClass("e-disabled");
            }
        }
        /**
        ...
        var showLayer = function(serial, skipGlobalButton) {
            ...
            if (skipGlobalButton != true) jQuery("#button_sort_visibility").removeClass("e-disabled");
        }
        /**
         * show all layers
         */
        var showAllLayers = function() {
            for (serial in arrLayers) showLayer(serial, true);
        }
        /**
         * hide all layers
         */
        var hideAllLayers = function() {
            for (serial in arrLayers) hideLayer(serial, true);
        }
        /**
         * hide in html and sortbox
         */
        var lockAllLayers = function(serial) {
            for (serial in arrLayers) lockLayer(serial);
        }
        /**
         * show layer in html and sortbox
         */
        var unlockAllLayers = function(serial) {
            for (serial in arrLayers) unlockLayer(serial);
        }
        /**
        ...
        var isAllLayersHidden = function() {
            for (serial in arrLayers) {
                if (isLayerVisible(serial) == true) return (false);
            }
            return (true);
        }
        /**
        ...
        var isLayerLocked = function(serial) {
            ...
            if (typeof(isLocked) == 'undefined') return false;
            else return (isLocked == 'false') ? false : true;
        }
        /**
         * hide in html and sortbox
         */
        ...
        var initSortbox = function() {
            ...
            jQuery("#sortlist").delegate(".sortbox_time", "keyup", function(event) {
                if (event.keyCode == 13) onSortboxTimeChange(jQuery(this));
            });
            ...
            jQuery("#sortlist").delegate(".sortbox_eye", "mousedown", function(event) {
                ...
                if (isLayerVisible(serial)) hideLayer(serial);
                else showLayer(serial);
            ...
            jQuery("#sortlist").delegate(".sortbox_lock", "mousedown", function(event) {
                var sortboxID = jQuery(this).parent().parent().parent().attr("id");
                var serial = getSerialFromSortID(sortboxID);
                if (isLayerLocked(serial)) unlockLayer(serial);
                else lockLayer(serial);
        ...
        var addToSortbox = function(serial, objLayer) {
            if (objLayer.realEndTime == "undefined" || objLayer.realEndTime == undefined) objLayer = getLayerExtendedParams(objLayer);
            var endslideclass = "";
            ...
            var classLI = "";
            if (isVisible == false) classLI = " sortitem-hidden";
            ...
            iwrapper.find('input').keypress(function(event) {
                if (event.keyCode == 13) changeTimerInputs();
	...
	*/
        var setCurTimer = function(timer) {
            ...
            if (objLayer.realEndTime == "undefined" || objLayer.realEndTime == undefined) objLayer = getLayerExtendedParams(objLayer);
            dragfull.css({
                width: ((objLayer.realEndTime - objLayer.time) / ft) * 100 + "%",
                left: ((objLayer.time) / ft) * 100 + "%"
            });
            dragstart.css({
                width: (objLayer.speed / ft) * tw + "px"
            });
            dragend.css({
                width: (objLayer.endspeed / ft) * tw + "px"
            });
            checkTillSlideEnd(li, objLayer);
            jQuery('#layer_endtime').val((objLayer.realEndTime - objLayer.endSpeedFinal));
        }
	...
	*/
        var updateCurTimer = function(event, timer) {
            ...
            if (event == "stop") {
                timer.css({
                    left: (timer.position().left / tw) * 100 + "%",
	...
	*/
        var showHideTimeines = function() {
            ...
            jQuery('#button_sort_timing').click(function() {
                ...
                if (bst.hasClass("off")) {
                    ...
                    punchgs.TweenLite.to(jQuery('#sortlist .timeline'), 0.5, {
                        autoAlpha: 0.5,
                        overwrite: "auto"
                    });
                } else {
        ...
        var getSortboxText = function(text) {
            ...
            if (textSortbox.length < 2) textSortbox = UniteAdminRev.htmlspecialchars(text);
            //short text
            if (textSortbox.length > sorboxTextSize) textSortbox = textSortbox.slice(0, sorboxTextSize) + "...";
            return (textSortbox);
        }
        /**
         *
        ...
        var getNextTime = function() {
            ...
            for (key in arrLayers) {
                ...
                if (layerTime > maxTime) maxTime = layerTime;
            }
            var outputTime;
            if (maxTime == 0) outputTime = g_startTime;
            else outputTime = Number(maxTime) + Number(g_stepTime);
            return (outputTime);
        }
        /**
        ...
        var getLayersSorted = function(type) {
            ...
            if (layers_array.length == 0) return (layers_array);
            //sort layers array
            layers_array.sort(function(layer1, layer2) {
                switch (type) {
                    case "time":
                        if (Number(layer1.time) == Number(layer2.time)) {
                            if (layer1.order == layer2.order) return (0);
                            if (layer1.order > layer2.order) return (1);
                            return (-1);
                        }
                        if (Number(layer1.time) > Number(layer2.time)) return (1);
                        break;
                    case "depth":
                        if (layer1.order == layer2.order) return (0);
                        if (layer1.order > layer2.order) return (1);
        ...
        var redistributeTimes = function() {
            ...
            var arrTimes = [];
            for (key in arrLayers) arrTimes.push(Number(arrLayers[key].time));
        ...
        var onLayerDrag = function() {
            ...
            if (isLayerSelected(layerSerial)) updateLayerFormFields(layerSerial);
        }
        /**
         * move some layer
         */
        var moveLayer = function(serial, dir, step) {
            ...
            if (isLayerSelected(serial)) updateLayerFormFields(serial);
        }
        //======================================================
        ...
        var getLayerExtendedParams = function(layer) {
            ...
            if (!endSpeed) endSpeed = layer.speed;
        ...
        var scaleImage = function() {
            jQuery("#layer_scaleX").change(function() {
                if (jQuery("#layer_proportional_scale").is(":checked")) scaleProportional(true);
                else scaleNormal();
            });
            jQuery("#layer_scaleY").change(function() {
                if (jQuery("#layer_proportional_scale").is(":checked")) scaleProportional(false);
                else scaleNormal();
            });
        ...
        var initBackgroundFunctions = function() {
            ...
            jQuery('input[name="kb_start_fit"]').change(function() {
                ...
                var urlImage = '';
                if (jQuery('#radio_back_image').is(':checked')) urlImage = jQuery("#image_url").val();
                else if (jQuery('#radio_back_external').is(':checked')) urlImage = jQuery("#slide_bg_external").val();
                if (urlImage != '') {
                    limg.src = urlImage;
                }
            });
        ...
        var layer_image_upload = function(field, static_type) {
            $('#dialog').remove();
            $('body').prepend('<div id="dialog" style="padding: 3px 0px 0px 0px;"><iframe src="index.php?route=common/filemanager&token=' + sds_rev_oc_token + '&field=' + encodeURIComponent(field) + '" style="padding:0; margin: 0; display: block; width: 100%; height: 100%;" frameborder="no" scrolling="auto"></iframe></div>');
            $('#dialog').dialog({
                title: 'Image Uploader',
                close: function(event, ui) {
                    if ($('#' + field).attr('value')) {
                        $.ajax({
                            url: 'index.php?route=common/filemanager/image&token=' + sds_rev_oc_token + '&image=' + encodeURIComponent($('#' + field).attr('value')),
                            dataType: 'text',
                            success: function(data) {
                                var img_src = sds_main_shop_up_url + $('#' + field).attr('value');
                                if (typeof static_type !== 'undefined') {
                                    addLayerImage(img_src, 'static');
                                } else {
                                    addLayerImage(img_src);
                                }
                            }
                        });
                    }
    ...
    // function layer_image_upload(field,static_type){
    // 	$('#dialog').remove();
    // 	$('body').prepend('<div id="dialog" style="padding: 3px 0px 0px 0px;"><iframe src="index.php?route=common/filemanager&token='+sds_rev_oc_token+'&field=' + encodeURIComponent(field) + '" style="padding:0; margin: 0; display: block; width: 100%; height: 100%;" frameborder="no" scrolling="auto"></iframe></div>');
    // 	$('#dialog').dialog({
    // 		title: 'Image Uploader',
