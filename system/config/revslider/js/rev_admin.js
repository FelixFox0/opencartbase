		...
		**/
		...
		this.initEditSliderView = function(){
			...
			jQuery("#button_export_slider").click(function(){
				...
				var urlAjaxExport = rev_site_admin_url+"?route=module/revslideropencart/ajaxexecute&action="+g_uniteDirPlagin+"_ajax_action&client_action=export_slider&dummy="+useDummy;
