	...
	class UniteSettingsRev{
		...
		public function loadXMLFile($filepath){
			...
			foreach($fieldsets as $fieldset){
				...
				if(isset(ControllerModulerevslideropencart::$lang_var[$sapLabel]))
					$sapLabel = (string)ControllerModulerevslideropencart::$lang_var[$sapLabel];
				...
				foreach($fields as $field){
					...
					if($fieldLabel != '' && isset(ControllerModulerevslideropencart::$lang_var[$fieldLabel]))
						$fieldLabel = ControllerModulerevslideropencart::$lang_var[$fieldLabel];
