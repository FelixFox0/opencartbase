<?php
	...
	if($slider->isSlidesFromPosts() == false){
		...
		if($isWpmlExists && $useWpml == "on"){
			...
			$textDelete = ControllerModulerevslideropencart::$lang_var

['Delete_Slider'];
			$textEdit = ControllerModulerevslideropencart::$lang_var

['Edit_Slide'];
			$textPreview = ControllerModulerevslideropencart::$lang_var
...
['Preview_Slide'];
		...
		$linkNewPost = UniteFunctionsRev::getHtmlLink($urlNewPost, ControllerModulerevslideropencart::$lang_var
