	<div class="postbox box-slideslist">
		<h3>
			<span class='slideslist-title'><?php echo ControllerModulerevslideropencart::

$lang_var['Slides_List']?></span>
			<span id="saving_indicator" class='slideslist-loading'><?php echo ControllerModulerevslideropencart::

$lang_var['Saving_Order']?>...</span>
		</h3>
		<div class="inside">
			<?php if(empty($arrSlides)):?>
			<?php echo ControllerModulerevslideropencart::

$lang_var['No_Slides_Found']?>
			<?php endif?>
				...
				?>
					<li id="slidelist_item_<?php echo $slideid?>" class="ui-state-default">
						...
						<span class="slide-col col-order">
							...
							<div class="icon_state state_published" data-slideid="<?php echo $slideid?>" title="<?php echo ControllerModulerevslideropencart::

$lang_var['Unpublish_Slide']?>"></div>
							<?php else:?>
							<div class="icon_state state_unpublished" data-slideid="<?php echo $slideid?>" title="<?php echo ControllerModulerevslideropencart::

$lang_var['Publish_Slide']?>"></div>
							<?php endif?>
						...
						<span class="slide-col col-name">
							...
							<a class='button-primary revgreen' href='<?php echo $urlEditSlide?>' style="width:120px; "><i class="revicon-pencil-1"></i><?php echo ControllerModulerevslideropencart::

$lang_var['Edit_Slide']?></a>
						</span>
						...
						<span class="slide-col col-operations">
							<a id="" class='button-primary revred button_delete_slide ' style="width:120px; margin-top:8px !important" data-slideid="<?php echo $slideid?>" href='javascript:void(0)'><i class="revicon-trash"></i><?php echo ControllerModulerevslideropencart::

$lang_var['Delete']?></a>
							<span class="loader_round loader_delete" style="display:none;"><?php echo ControllerModulerevslideropencart::$lang_var['Deleting_Slide']?></span>
							<a id="button_duplicate_slide_<?php echo $slideid?>" style="width:120px; " class='button-primary revyellow button_duplicate_slide' href='javascript:void(0)'><i class="revicon-picture"></i><?php echo ControllerModulerevslideropencart::

$lang_var['Duplicate']?></a>
							<?php
								$copyButtonClass = "button-primary revblue  button_copy_slide";
								$copyButtonTitle = ControllerModulerevslideropencart::$lang_var
...
['copy_move_dialog'];
							...
							?>
							<a id="button_copy_slide_<?php echo $slideid?>" class='<?php echo $copyButtonClass?>' title="<?php echo $copyButtonTitle?>" style="width:120px; " href='javascript:void(0)'><i class="revicon-picture"></i><?php echo ControllerModulerevslideropencart::

$lang_var['copy_move']?></a>							
							<span class="loader_round loader_copy mtop_10 mleft_20 display_block" style="display:none;"><?php echo ControllerModulerevslideropencart::

$lang_var['Working']?></span>
						</span>
