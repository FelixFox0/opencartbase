              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <?php if ($name == 'Footer' || $name == 'footer') { ?> 
                 ...
                 <?php } else { ?>   
                    ...
                    <?php if ($layout_module['position'] == 'home_top_top') { ?>
                    <option value="home_top_top" selected="selected">Home top (Top)</option>
                    <?php } else { ?>
                    <option value="home_top_top">Home top (Top)</option>
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'home_top_left') { ?>
                    <option value="home_top_left" selected="selected">Home top (Left)</option>
                    <?php } else { ?>
                    <option value="home_top_left">Home top (Left)</option>
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'home_top_c') { ?>
                    <option value="home_top_c" selected="selected">Home top (Center)</option>
                    <?php } else { ?>
                    <option value="home_top_c">Home top (Center)</option>
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'home_top_right') { ?>
                    ...
                    <?php } ?>
                    <?php if (isset($is_home)) { ?>
                    <?php if ($layout_module['position'] == 'content_btm_h') { ?>
                    <option value="content_btm_h" selected="selected">Home content middle (1/2)</option>
                    <?php } else { ?>
                    <option value="content_btm_h">Home content middle (1/2)</option>
                    <?php } ?>
                    <?php } ?>
...
function addModule() {
	...
	html += '    <option value="home_top_c">Home top (Center)</option>';
	html += '    <option value="home_top_right">Home top (Right)</option>';
	<?php } ?>
	html += '    <option value="content_top"><?php echo $text_content_top; ?></option>';
	<?php if (isset($is_home)) { ?>
	html += '    <option value="content_btm_h" selected="selected">Home content middle (1/2)</option>';
	<?php } ?>
