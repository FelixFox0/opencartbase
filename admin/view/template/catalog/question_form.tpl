      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-question" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-text"><?php echo $entry_answer; ?></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="status" id="input-status" class="form-control" <?php if ($private) { echo 'disabled="disabled"'; } ?>>
                <?php if ($status) { ?>
              ...
              <span style="line-height:32px;"><?php echo $info_private; ?></span>
              <?php } ?>
            </div>
          </div>
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-status"><span data-toggle="tooltip" title="<?php echo $entry_notify_help; ?>"><?php echo $entry_notify; ?></span></label>
            <div class="col-sm-10">
