          ...
          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-advajaxfilter" class="form-horizontal">
            ...
            <div>
                <style type="text/css">
                                ...
                                <table id="settings" class="list" style="width: 60% !important; float: left">
                                    <thead>
                                        <tr>
                                            ...
                                            <td><input type="checkbox" id="expand_all">&nbsp;<?php echo $text_expanded?></td>
                                        </tr>
                                    </thead>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="3" style="text-align: center;">Options</td>
                                    </tr>
                                    ...
                                    <?php if ($attribute_group !=$attribute['attribute_group']) { ?>
                                        ...
                                        <tr>
                                            <td colspan="3" style="text-align: center;"><?php echo $attribute['attribute_group']. ' (Attribute Group)'?></td>
                                        </tr>
                                    <?php }	?>
                                    <tr>
                    ...
                    <table id="module" class="list hidden">
                        <thead>
                            <tr>
                                ...
                                <td class="left"><?php echo $entry_module_hover_color; ?></td>
                                <td class="left"><?php echo $entry_module_text_color; ?></td>
                                <td></td>
                            </tr>
                        </thead>
                        <?php $module_row = 0; ?>
                        ...
                        <tbody id="module-row<?php echo $module_row; ?>">
                            <tr>
                                ...
                                <td class="left"><input class="color" type="text" name="adv_ajaxfilter_module[<?php echo $module_row; ?>][module_hover_color]" value="<?php echo $module['module_hover_color']; ?>" size="7" /></td>
                                <td class="left"><input class="color" type="text" name="adv_ajaxfilter_module[<?php echo $module_row; ?>][module_text_color]" value="<?php echo $module['module_text_color']; ?>" size="7" /></td>
							</tr>
                        </tbody>
                        <?php $module_row++; ?>
                        <?php } ?>
						...
						<tbody id="module-row0">
							<tr>
								<td class="left"><input type="text" name="adv_ajaxfilter_module[0][module_title]" value="" size="30" /></td>
								<td class="left"><input class="color" type="text" name="adv_ajaxfilter_module[0][module_color]" value="0088CC" size="7" /></td>
								<td class="left"><input class="color" type="text" name="adv_ajaxfilter_module[0][module_border_color]" value="39C6FA" size="7" /></td>
								<td class="left"><input class="color" type="text" name="adv_ajaxfilter_module[0][module_hover_color]" value="2896FA" size="7" /></td>
								<td class="left"><input class="color" type="text" name="adv_ajaxfilter_module[0][module_text_color]" value="FFFFFF" size="7" /></td>
							</tr>
						</tbody>
						<?php } ?>
                        <tfoot>
...
function addModule() {
	...
	html += '  <tr>';
    html += '   <td class="left"><input type="text" name="adv_ajaxfilter_module[' + module_row + '][module_title]" value="" size="30" /></td>';
    html += '   <td class="left"><input class="color" type="text" name="adv_ajaxfilter_module[' + module_row + '][module_color]" value="0088CC" size="7" /></td>';
    html += '   <td class="left"><input class="color" type="text" name="adv_ajaxfilter_module[' + module_row + '][module_border_color]" value="39C6FA" size="7" /></td>';
    html += '   <td class="left"><input class="color" type="text" name="adv_ajaxfilter_module[' + module_row + '][module_hover_color]" value="2896FA" size="7" /></td>';
    html += '   <td class="left"><input class="color" type="text" name="adv_ajaxfilter_module[' + module_row + '][module_text_color]" value="FFFFFF" size="7" /></td>';
