...
class ControllerModuleAdvajaxfilter extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/adv_ajaxfilter', 'token=' . $this->session->data['token'], true),
			'separator' => ' :: '
		);

		$data['action'] = $this->url->link('module/adv_ajaxfilter', 'token=' . $this->session->data['token'], true);
        ...
        $this->document->addScript('view/javascript/advcolorpicker/jscolor.js');
