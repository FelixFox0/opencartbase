...
class ControllerModuleCosyoneProductbrand extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/cosyone_productbrand', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('module/cosyone_productbrand', 'token=' . $this->session->data['token'], true);
