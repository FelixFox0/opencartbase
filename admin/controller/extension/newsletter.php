...
class ControllerExtensionNewsletter extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/newsletter', 'token=' . $this->session->data['token'] . $url, true)
		);
		...
		$pagination->url = $this->url->link('extension/newsletter', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$data['delete'] = $this->url->link('extension/newsletter/delete', 'token=' . $this->session->data['token'], true);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			$this->response->redirect($this->url->link('extension/newsletter', 'token=' . $this->session->data['token'], true));
		} else {
